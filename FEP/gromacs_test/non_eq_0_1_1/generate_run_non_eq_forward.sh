...
gmx mdrun -s eq_${init_lambda}.tpr -ntomp 4 -deffnm eq_${init_lambda}
gmx grompp -f ti_${init_lambda}.mdp -c eq_${init_lambda}.gro -r eq_${init_lambda}.gro -p $input_files/topol.top -o ti_${init_lambda}.tpr -maxwarn 5 
gmx mdrun -s ti_${init_lambda}.tpr -ntomp 4 -deffnm $outfile
